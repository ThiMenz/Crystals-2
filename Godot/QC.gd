...
func set_edges():
	edges = [
		4 * QC.randomizePositionOffset(pos, mapGen.randomizationStrength),
		4 * QC.randomizePositionOffset(pos+Vector2i(1,0), mapGen.randomizationStrength),
		4 * QC.randomizePositionOffset(pos+Vector2i(0,1), mapGen.randomizationStrength),
		4 * QC.randomizePositionOffset(pos+Vector2i(1,1), mapGen.randomizationStrength)
	]
